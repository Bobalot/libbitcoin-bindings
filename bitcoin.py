...
class py_output_value_list(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def iterator(self): return _bitcoin.py_output_value_list_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _bitcoin.py_output_value_list___nonzero__(self)
    def __bool__(self): return _bitcoin.py_output_value_list___bool__(self)
    def __len__(self): return _bitcoin.py_output_value_list___len__(self)
    def pop(self): return _bitcoin.py_output_value_list_pop(self)
    def __getslice__(self, *args): return _bitcoin.py_output_value_list___getslice__(self, *args)
    def __setslice__(self, *args): return _bitcoin.py_output_value_list___setslice__(self, *args)
    def __delslice__(self, *args): return _bitcoin.py_output_value_list___delslice__(self, *args)
    def __delitem__(self, *args): return _bitcoin.py_output_value_list___delitem__(self, *args)
    def __getitem__(self, *args): return _bitcoin.py_output_value_list___getitem__(self, *args)
    def __setitem__(self, *args): return _bitcoin.py_output_value_list___setitem__(self, *args)
    def append(self, *args): return _bitcoin.py_output_value_list_append(self, *args)
    def empty(self): return _bitcoin.py_output_value_list_empty(self)
    def size(self): return _bitcoin.py_output_value_list_size(self)
    def clear(self): return _bitcoin.py_output_value_list_clear(self)
    def swap(self, *args): return _bitcoin.py_output_value_list_swap(self, *args)
    def get_allocator(self): return _bitcoin.py_output_value_list_get_allocator(self)
    def begin(self): return _bitcoin.py_output_value_list_begin(self)
    def end(self): return _bitcoin.py_output_value_list_end(self)
    def rbegin(self): return _bitcoin.py_output_value_list_rbegin(self)
    def rend(self): return _bitcoin.py_output_value_list_rend(self)
    def pop_back(self): return _bitcoin.py_output_value_list_pop_back(self)
    def erase(self, *args): return _bitcoin.py_output_value_list_erase(self, *args)
    def __init__(self, *args): 
        this = _bitcoin.new_py_output_value_list(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _bitcoin.py_output_value_list_push_back(self, *args)
    def front(self): return _bitcoin.py_output_value_list_front(self)
    def back(self): return _bitcoin.py_output_value_list_back(self)
    def assign(self, *args): return _bitcoin.py_output_value_list_assign(self, *args)
    def resize(self, *args): return _bitcoin.py_output_value_list_resize(self, *args)
    def insert(self, *args): return _bitcoin.py_output_value_list_insert(self, *args)
    def reserve(self, *args): return _bitcoin.py_output_value_list_reserve(self, *args)
    def capacity(self): return _bitcoin.py_output_value_list_capacity(self)
    __swig_destroy__ = _bitcoin.delete_py_output_value_list
    __del__ = lambda self : None;
py_output_value_list_swigregister = _bitcoin.py_output_value_list_swigregister
py_output_value_list_swigregister(py_output_value_list)

class py_short_hash(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def size(self): return _bitcoin.py_short_hash_size(self)
    def at(self, *args): return _bitcoin.py_short_hash_at(self, *args)
    def __len__(self): return _bitcoin.py_short_hash___len__(self)
    def _get(self, *args): return _bitcoin.py_short_hash__get(self, *args)
    def _set(self, *args): return _bitcoin.py_short_hash__set(self, *args)
    ...
    def __init__(self): 
        this = _bitcoin.new_py_short_hash()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _bitcoin.delete_py_short_hash
    __del__ = lambda self : None;
py_short_hash_swigregister = _bitcoin.py_short_hash_swigregister
py_short_hash_swigregister(py_short_hash)

class py_hash_digest(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def size(self): return _bitcoin.py_hash_digest_size(self)
    def at(self, *args): return _bitcoin.py_hash_digest_at(self, *args)
    def __len__(self): return _bitcoin.py_hash_digest___len__(self)
    def _get(self, *args): return _bitcoin.py_hash_digest__get(self, *args)
    def _set(self, *args): return _bitcoin.py_hash_digest__set(self, *args)
    def __getitem__(self, key): 
        if isinstance(key, slice): 
            return tuple(self._get(i) for i in range(*key.indices(len(self)))) 
    ...
    def copy(self, *args): return _bitcoin.py_hash_digest_copy(self, *args)
    def raw(self): return _bitcoin.py_hash_digest_raw(self)
    def __init__(self): 
        this = _bitcoin.new_py_hash_digest()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _bitcoin.delete_py_hash_digest
    __del__ = lambda self : None;
py_hash_digest_swigregister = _bitcoin.py_hash_digest_swigregister
py_hash_digest_swigregister(py_hash_digest)

class py_hash_digest_list(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def iterator(self): return _bitcoin.py_hash_digest_list_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _bitcoin.py_hash_digest_list___nonzero__(self)
    def __bool__(self): return _bitcoin.py_hash_digest_list___bool__(self)
    def __len__(self): return _bitcoin.py_hash_digest_list___len__(self)
    def pop(self): return _bitcoin.py_hash_digest_list_pop(self)
    def __getslice__(self, *args): return _bitcoin.py_hash_digest_list___getslice__(self, *args)
    def __setslice__(self, *args): return _bitcoin.py_hash_digest_list___setslice__(self, *args)
    def __delslice__(self, *args): return _bitcoin.py_hash_digest_list___delslice__(self, *args)
    def __delitem__(self, *args): return _bitcoin.py_hash_digest_list___delitem__(self, *args)
    def __getitem__(self, *args): return _bitcoin.py_hash_digest_list___getitem__(self, *args)
    def __setitem__(self, *args): return _bitcoin.py_hash_digest_list___setitem__(self, *args)
    def append(self, *args): return _bitcoin.py_hash_digest_list_append(self, *args)
    def empty(self): return _bitcoin.py_hash_digest_list_empty(self)
    def size(self): return _bitcoin.py_hash_digest_list_size(self)
    def clear(self): return _bitcoin.py_hash_digest_list_clear(self)
    def swap(self, *args): return _bitcoin.py_hash_digest_list_swap(self, *args)
    def get_allocator(self): return _bitcoin.py_hash_digest_list_get_allocator(self)
    def begin(self): return _bitcoin.py_hash_digest_list_begin(self)
    def end(self): return _bitcoin.py_hash_digest_list_end(self)
    def rbegin(self): return _bitcoin.py_hash_digest_list_rbegin(self)
    def rend(self): return _bitcoin.py_hash_digest_list_rend(self)
    def pop_back(self): return _bitcoin.py_hash_digest_list_pop_back(self)
    def erase(self, *args): return _bitcoin.py_hash_digest_list_erase(self, *args)
    def __init__(self, *args): 
        this = _bitcoin.new_py_hash_digest_list(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _bitcoin.py_hash_digest_list_push_back(self, *args)
    def front(self): return _bitcoin.py_hash_digest_list_front(self)
    def back(self): return _bitcoin.py_hash_digest_list_back(self)
    def assign(self, *args): return _bitcoin.py_hash_digest_list_assign(self, *args)
    def resize(self, *args): return _bitcoin.py_hash_digest_list_resize(self, *args)
    def insert(self, *args): return _bitcoin.py_hash_digest_list_insert(self, *args)
    def reserve(self, *args): return _bitcoin.py_hash_digest_list_reserve(self, *args)
    def capacity(self): return _bitcoin.py_hash_digest_list_capacity(self)
    __swig_destroy__ = _bitcoin.delete_py_hash_digest_list
    __del__ = lambda self : None;
py_hash_digest_list_swigregister = _bitcoin.py_hash_digest_list_swigregister
py_hash_digest_list_swigregister(py_hash_digest_list)
...
class sh_block_type(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def _get_block_type_unsafe(self): return _bitcoin.sh_block_type__get_block_type_unsafe(self)
    @property
    def header(self):
    ...
    def __init__(self): 
        this = _bitcoin.new_sh_block_type()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _bitcoin.delete_sh_block_type
    __del__ = lambda self : None;
sh_block_type_swigregister = _bitcoin.sh_block_type_swigregister
sh_block_type_swigregister(sh_block_type)

class py_block_list(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def iterator(self): return _bitcoin.py_block_list_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _bitcoin.py_block_list___nonzero__(self)
    def __bool__(self): return _bitcoin.py_block_list___bool__(self)
    def __len__(self): return _bitcoin.py_block_list___len__(self)
    def pop(self): return _bitcoin.py_block_list_pop(self)
    def __getslice__(self, *args): return _bitcoin.py_block_list___getslice__(self, *args)
    def __setslice__(self, *args): return _bitcoin.py_block_list___setslice__(self, *args)
    def __delslice__(self, *args): return _bitcoin.py_block_list___delslice__(self, *args)
    def __delitem__(self, *args): return _bitcoin.py_block_list___delitem__(self, *args)
    def __getitem__(self, *args): return _bitcoin.py_block_list___getitem__(self, *args)
    def __setitem__(self, *args): return _bitcoin.py_block_list___setitem__(self, *args)
    def append(self, *args): return _bitcoin.py_block_list_append(self, *args)
    def empty(self): return _bitcoin.py_block_list_empty(self)
    def size(self): return _bitcoin.py_block_list_size(self)
    def clear(self): return _bitcoin.py_block_list_clear(self)
    def swap(self, *args): return _bitcoin.py_block_list_swap(self, *args)
    def get_allocator(self): return _bitcoin.py_block_list_get_allocator(self)
    def begin(self): return _bitcoin.py_block_list_begin(self)
    def end(self): return _bitcoin.py_block_list_end(self)
    def rbegin(self): return _bitcoin.py_block_list_rbegin(self)
    def rend(self): return _bitcoin.py_block_list_rend(self)
    def pop_back(self): return _bitcoin.py_block_list_pop_back(self)
    def erase(self, *args): return _bitcoin.py_block_list_erase(self, *args)
    def __init__(self, *args): 
        this = _bitcoin.new_py_block_list(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _bitcoin.py_block_list_push_back(self, *args)
    def front(self): return _bitcoin.py_block_list_front(self)
    def back(self): return _bitcoin.py_block_list_back(self)
    def assign(self, *args): return _bitcoin.py_block_list_assign(self, *args)
    def resize(self, *args): return _bitcoin.py_block_list_resize(self, *args)
    def insert(self, *args): return _bitcoin.py_block_list_insert(self, *args)
    def reserve(self, *args): return _bitcoin.py_block_list_reserve(self, *args)
    def capacity(self): return _bitcoin.py_block_list_capacity(self)
    __swig_destroy__ = _bitcoin.delete_py_block_list
    __del__ = lambda self : None;
py_block_list_swigregister = _bitcoin.py_block_list_swigregister
py_block_list_swigregister(py_block_list)

class sh_channel(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def _get_channel_unsafe(self): return _bitcoin.sh_channel__get_channel_unsafe(self)
    def send_version(self, *args): return _bitcoin.sh_channel_send_version(self, *args)
    ...
    def __init__(self): 
        this = _bitcoin.new_sh_channel()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _bitcoin.delete_sh_channel
    __del__ = lambda self : None;
sh_channel_swigregister = _bitcoin.sh_channel_swigregister
sh_channel_swigregister(sh_channel)

class sh_acceptor(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def _get_acceptor_unsafe(self): return _bitcoin.sh_acceptor__get_acceptor_unsafe(self)
    def accept(self, handler):
        return self._get_acceptor_unsafe().accept(handler)

    def __init__(self): 
        this = _bitcoin.new_sh_acceptor()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _bitcoin.delete_sh_acceptor
    __del__ = lambda self : None;
sh_acceptor_swigregister = _bitcoin.sh_acceptor_swigregister
sh_acceptor_swigregister(sh_acceptor)
...
def python_block_header_type_cb_handler(*args):
  return _bitcoin.python_block_header_type_cb_handler(*args)
python_block_header_type_cb_handler = _bitcoin.python_block_header_type_cb_handler
...
def python_hash_digest_list_cb_handler(*args):
  return _bitcoin.python_hash_digest_list_cb_handler(*args)
python_hash_digest_list_cb_handler = _bitcoin.python_hash_digest_list_cb_handler
...
def python_output_value_list_cb_handler(*args):
  return _bitcoin.python_output_value_list_cb_handler(*args)
python_output_value_list_cb_handler = _bitcoin.python_output_value_list_cb_handler
...
def python_txidx_cb_handler(*args):
  return _bitcoin.python_txidx_cb_handler(*args)
python_txidx_cb_handler = _bitcoin.python_txidx_cb_handler

def python_history_cb_handler(*args):
  return _bitcoin.python_history_cb_handler(*args)
python_history_cb_handler = _bitcoin.python_history_cb_handler
...
def python_acceptor_cb_handler(*args):
  return _bitcoin.python_acceptor_cb_handler(*args)
python_acceptor_cb_handler = _bitcoin.python_acceptor_cb_handler
...
zero = _bitcoin.zero
special = _bitcoin.special
pushdata1 = _bitcoin.pushdata1
pushdata2 = _bitcoin.pushdata2
pushdata4 = _bitcoin.pushdata4
negative_1 = _bitcoin.negative_1
reserved = _bitcoin.reserved
op_1 = _bitcoin.op_1
op_2 = _bitcoin.op_2
op_3 = _bitcoin.op_3
op_4 = _bitcoin.op_4
...
op_8 = _bitcoin.op_8
op_9 = _bitcoin.op_9
op_10 = _bitcoin.op_10
op_11 = _bitcoin.op_11
op_12 = _bitcoin.op_12
op_13 = _bitcoin.op_13
op_14 = _bitcoin.op_14
op_15 = _bitcoin.op_15
op_16 = _bitcoin.op_16
nop = _bitcoin.nop
ver = _bitcoin.ver
if_ = _bitcoin.if_
notif = _bitcoin.notif
verif = _bitcoin.verif
vernotif = _bitcoin.vernotif
else_ = _bitcoin.else_
endif = _bitcoin.endif
verify = _bitcoin.verify
return_ = _bitcoin.return_
toaltstack = _bitcoin.toaltstack
fromaltstack = _bitcoin.fromaltstack
op_2drop = _bitcoin.op_2drop
op_2dup = _bitcoin.op_2dup
op_3dup = _bitcoin.op_3dup
op_2over = _bitcoin.op_2over
op_2rot = _bitcoin.op_2rot
op_2swap = _bitcoin.op_2swap
ifdup = _bitcoin.ifdup
depth = _bitcoin.depth
drop = _bitcoin.drop
dup = _bitcoin.dup
nip = _bitcoin.nip
over = _bitcoin.over
...
tuck = _bitcoin.tuck
cat = _bitcoin.cat
substr = _bitcoin.substr
left = _bitcoin.left
right = _bitcoin.right
size = _bitcoin.size
invert = _bitcoin.invert
and_ = _bitcoin.and_
or_ = _bitcoin.or_
xor_ = _bitcoin.xor_
equal = _bitcoin.equal
equalverify = _bitcoin.equalverify
reserved1 = _bitcoin.reserved1
reserved2 = _bitcoin.reserved2
op_1add = _bitcoin.op_1add
op_1sub = _bitcoin.op_1sub
op_2mul = _bitcoin.op_2mul
op_2div = _bitcoin.op_2div
negate = _bitcoin.negate
abs = _bitcoin.abs
not_ = _bitcoin.not_
op_0notequal = _bitcoin.op_0notequal
add = _bitcoin.add
sub = _bitcoin.sub
mul = _bitcoin.mul
div = _bitcoin.div
mod = _bitcoin.mod
lshift = _bitcoin.lshift
rshift = _bitcoin.rshift
booland = _bitcoin.booland
boolor = _bitcoin.boolor
numequal = _bitcoin.numequal
numequalverify = _bitcoin.numequalverify
numnotequal = _bitcoin.numnotequal
lessthan = _bitcoin.lessthan
greaterthan = _bitcoin.greaterthan
lessthanorequal = _bitcoin.lessthanorequal
greaterthanorequal = _bitcoin.greaterthanorequal
min = _bitcoin.min
max = _bitcoin.max
within = _bitcoin.within
ripemd160 = _bitcoin.ripemd160
sha1 = _bitcoin.sha1
sha256 = _bitcoin.sha256
hash160 = _bitcoin.hash160
hash256 = _bitcoin.hash256
codeseparator = _bitcoin.codeseparator
checksig = _bitcoin.checksig
checksigverify = _bitcoin.checksigverify
checkmultisig = _bitcoin.checkmultisig
checkmultisigverify = _bitcoin.checkmultisigverify
op_nop1 = _bitcoin.op_nop1
op_nop2 = _bitcoin.op_nop2
op_nop3 = _bitcoin.op_nop3
op_nop4 = _bitcoin.op_nop4
op_nop5 = _bitcoin.op_nop5
op_nop6 = _bitcoin.op_nop6
op_nop7 = _bitcoin.op_nop7
op_nop8 = _bitcoin.op_nop8
op_nop9 = _bitcoin.op_nop9
op_nop10 = _bitcoin.op_nop10
bad_operation = _bitcoin.bad_operation
raw_data = _bitcoin.raw_data
...
pubkey = _bitcoin.pubkey
pubkey_hash = _bitcoin.pubkey_hash
script_hash = _bitcoin.script_hash
multisig = _bitcoin.multisig
non_standard = _bitcoin.non_standard
class script(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
class output_point(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    hash_inst = _swig_property(_bitcoin.output_point_hash_inst_get, _bitcoin.output_point_hash_inst_set)
...
class block_header_type(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    version = _swig_property(_bitcoin.block_header_type_version_get, _bitcoin.block_header_type_version_set)
    previous_block_hash = _swig_property(_bitcoin.block_header_type_previous_block_hash_get, _bitcoin.block_header_type_previous_block_hash_set)
    merkle = _swig_property(_bitcoin.block_header_type_merkle_get, _bitcoin.block_header_type_merkle_set)
    timestamp = _swig_property(_bitcoin.block_header_type_timestamp_get, _bitcoin.block_header_type_timestamp_set)
    bits = _swig_property(_bitcoin.block_header_type_bits_get, _bitcoin.block_header_type_bits_set)
    nonce = _swig_property(_bitcoin.block_header_type_nonce_get, _bitcoin.block_header_type_nonce_set)
    def __init__(self): 
        this = _bitcoin.new_block_header_type()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _bitcoin.delete_block_header_type
    __del__ = lambda self : None;
block_header_type_swigregister = _bitcoin.block_header_type_swigregister
block_header_type_swigregister(block_header_type)

class block_type(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    header = _swig_property(_bitcoin.block_type_header_get, _bitcoin.block_type_header_set)
...
class payment_address(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    pubkey_version = _bitcoin.payment_address_pubkey_version
    script_version = _bitcoin.payment_address_script_version
    def __init__(self, *args): 
        this = _bitcoin.new_payment_address(*args)
        try: self.this.append(this)
        except: self.this = this
    def set(self, *args): return _bitcoin.payment_address_set(self, *args)
    def set_raw(self, *args): return _bitcoin.payment_address_set_raw(self, *args)
    def hash(self): return _bitcoin.payment_address_hash(self)
    def type(self): return _bitcoin.payment_address_type(self)
    def set_encoded(self, *args): return _bitcoin.payment_address_set_encoded(self, *args)
    def encoded(self): return _bitcoin.payment_address_encoded(self)
    def version(self): return _bitcoin.payment_address_version(self)
    __swig_destroy__ = _bitcoin.delete_payment_address
    __del__ = lambda self : None;
payment_address_swigregister = _bitcoin.payment_address_swigregister
payment_address_swigregister(payment_address)


def set_public_key_hash(*args):
  return _bitcoin.set_public_key_hash(*args)
set_public_key_hash = _bitcoin.set_public_key_hash

def set_script_hash(*args):
  return _bitcoin.set_script_hash(*args)
set_script_hash = _bitcoin.set_script_hash

def set_public_key(*args):
  return _bitcoin.set_public_key(*args)
set_public_key = _bitcoin.set_public_key

def set_script(*args):
  return _bitcoin.set_script(*args)
set_script = _bitcoin.set_script

def extract(*args):
  return _bitcoin.extract(*args)
extract = _bitcoin.extract
...
def fetch_history(*args):
  return _bitcoin.fetch_history(*args)
fetch_history = _bitcoin.fetch_history

def fetch_output_values(*args):
  return _bitcoin.fetch_output_values(*args)
fetch_output_values = _bitcoin.fetch_output_values
